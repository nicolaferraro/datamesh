...
type DataMeshClient interface {
	...
	ProcessQueue(ctx context.Context, in *Empty, opts ...grpc.CallOption) (DataMesh_ProcessQueueClient, error)
...
func (c *dataMeshClient) ProcessQueue(ctx context.Context, in *Empty, opts ...grpc.CallOption) (DataMesh_ProcessQueueClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_DataMesh_serviceDesc.Streams[0], c.cc, "/protobuf.DataMesh/ProcessQueue", opts...)
	if err != nil {
		return nil, err
	}
	x := &dataMeshProcessQueueClient{stream}
...
type DataMesh_ProcessQueueClient interface {
	Recv() (*Event, error)
	grpc.ClientStream
}

type dataMeshProcessQueueClient struct {
	grpc.ClientStream
}

func (x *dataMeshProcessQueueClient) Recv() (*Event, error) {
	m := new(Event)
...
type DataMeshServer interface {
	...
	// The server sends events that need to be processed. The client will reply with the corresponding transactions asynchronously.
	ProcessQueue(*Empty, DataMesh_ProcessQueueServer) error
	// Used by the client to query the projections.
...
func _DataMesh_ProcessQueue_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(Empty)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(DataMeshServer).ProcessQueue(m, &dataMeshProcessQueueServer{stream})
}

type DataMesh_ProcessQueueServer interface {
	Send(*Event) error
	grpc.ServerStream
}

type dataMeshProcessQueueServer struct {
	grpc.ServerStream
}

func (x *dataMeshProcessQueueServer) Send(m *Event) error {
	...
	Streams: []grpc.StreamDesc{
		{
			...
			Handler:       _DataMesh_ProcessQueue_Handler,
			ServerStreams: true,
		},
	},
...
var fileDescriptor0 = []byte{
	...
	,
}
